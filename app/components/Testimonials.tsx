...
const testimonials = [
  {
    name: "Fatima Khan",
    rating: 5,
    text: "Dr. Asif is incredibly gentle and professional. I was terrified of dentists my whole life, but my root canal was completely painless. The clinic is spotless and the staff is amazing!",
    verified: true,
    initial: "FK",
  ...
  },
  {
    name: "Ayesha Malik",
    rating: 5,
    text: "My daughter got her aligners here and the transformation has been incredible. Dr. Asif explains everything clearly and makes sure the patient is comfortable at every step.",
    verified: true,
    initial: "AM",
  ...
  },
  {
    name: "Hassan Ali",
    rating: 5,
    text: "Best dental clinic in Lahore, hands down. The 3-tier sterilization protocol gave me confidence. My dental implant looks and feels completely natural. Thank you, Dr. Asif!",
    verified: true,
    initial: "HA",
  ...
  },
  {
    name: "Bilal Ahmed",
    rating: 5,
    text: "Dr. Asif saved my tooth with a single-sitting root canal. I was in severe pain and he fit me in the same day. The pain-free technology is real — no exaggeration!",
    verified: true,
    initial: "BA",
