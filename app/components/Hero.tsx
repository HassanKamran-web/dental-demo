        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <p className="text-lg text-slate-600 leading-relaxed mb-8 max-w-xl">
              Comprehensive dental treatment by Dr. Asif Mansoori using advanced
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-10">
              <a
                href="https://wa.me/923211234567?text=Hello%20Dr.%20Asif%2C%20I%20would%20like%20to%20book%20an%20appointment."
                target="_blank"
